...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private String getJwtAccessTokenFromRequest(HttpServletRequest request){
        ...
        // Bearer isufdufvuev.wergvergvetgergvetrg.wrgvethgry

        if(StringUtils.hasText(bearerToken) && bearerToken.startsWith(JwtService.)){
            return bearerToken.substring(JwtService.TOKEN_PREFIX)
        }
    }
